...
/**
 * A Tetris piece model for LPieceLeft (the left pointing L piece)
 * 
 * @version 2.0
...
public class LPieceLeft extends Piece{ //works @ 7:21
	...
	*/
    ...
    public LPieceLeft(PlayingField field, int x, int y) {
